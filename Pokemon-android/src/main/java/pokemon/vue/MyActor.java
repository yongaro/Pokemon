...
import com.badlogic.gdx.scenes.scene2d.actions.*;
 ...
 public class MyActor extends Actor {
	    ...
	    public MyActor (float x, float y) {
	    	this.x=x;
	    	this.y=y;
	    	System.out.print(MyGdxGame.m.getCities().get(0).getX());
	        this.setBounds(x+MyGdxGame.m.getCities().get(0).getX(),y+MyGdxGame.m.getCities().get(0).getY(),s.getWidth(),s.getHeight());
