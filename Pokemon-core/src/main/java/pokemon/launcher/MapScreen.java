...
public class MapScreen extends GameScreen{
	...
	private PokemonCore game;
	
	//Attributs joueur
	private Joueur j = PokemonCore.Jtest;
    ...
    //Constructeurs
    public MapScreen(PokemonCore game) {
		this.game = game;
	...
	public void show() {
		...
		controller.unfreeze();
		Musics.play(PokemonCore.Jtest.getCurrentMap().getMusique().getPath());
	}
