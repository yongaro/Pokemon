...
public class PokemonMenuListenner extends GameInput{
	...
	public PokemonMenuListenner(menuPokemon menu,PokemonCore myGdxGame) {
		state=1;
		pkselector=0;
		atkselector=1;
	...
	PokemonMenuListenner(menuPokemon menu,PokemonCore myGdxGame, MenuListener menuListener)
	{
		this.menu=menu;
		state=1;
		pkselector=0;
